...
import useSellerSearchedProducts from "../../../hooks/useSellerSearchedProducts";
import Swal from "sweetalert2";
import useAxiosSecure from "../../../hooks/useAxiosSecure";
// import AnimateText from "@moxy/react-animate-text";

const SellerProducts = () => {
  const [products, isProductsLoading, refetch] = useSellerProducts();
  const [displayedProducts, setDisplayedProducts] = useState(products || []);
  const [searchText, setSearchText] = useState("");
  const [searchedProducts, isSearchLoading] = useSellerSearchedProducts(searchText);
    ...
    <div className="px-4">
      ...
      <div className="p-4 shadow mt-10 border rounded-lg">
        <header className="flex flex-col md:flex-row justify-between items-stretch space-y-3 md:space-y-0">
          ...
          <Link to="/dashboard/sellerAddProducts" className="md:w-[15%]">
